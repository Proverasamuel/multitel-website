...
@Component({
  selector: 'app-carrossel-mais-multitel',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './carrossel-mais-multitel.component.html',
  styleUrl: './carrossel-mais-multitel.component.css'
})
export class CarrosselMaisMultitelComponent implements OnInit, OnDestroy {
  currentSlide = 0;
